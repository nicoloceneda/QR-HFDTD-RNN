...
symbol_list = ['AAPL']
run_list = [2, 5, 6]
batch_size_list = [4421, 100, 4421]
hidden_dim_list = [16, 32, 32]
n_epochs_list = [10, 10, 10]
...
for symbol in symbol_list:
    ...
    for i in range(4):
        ...
        X_train = pd.read_csv('data/mode sl/datasets std noj upgrade/' + symbol_elle + '/X_train.csv')
        X_valid = pd.read_csv('data/mode sl/datasets std noj upgrade/' + symbol_elle + '/X_valid.csv')
        X_test = pd.read_csv('data/mode sl/datasets std noj upgrade/' + symbol_elle + '/X_test.csv')

        Y_train = pd.read_csv('data/mode sl/datasets std noj upgrade/' + symbol_elle + '/Y_train.csv')
        Y_valid = pd.read_csv('data/mode sl/datasets std noj upgrade/' + symbol_elle + '/Y_valid.csv')
        Y_test = pd.read_csv('data/mode sl/datasets std noj upgrade/' + symbol_elle + '/Y_test.csv')
        ...
        if not os.path.isdir('data/mode sl/results noj upgrade/'):

            os.mkdir('data/mode sl/results noj upgrade/')

        if not os.path.isdir('data/mode sl/results noj upgrade/' + symbol_elle):

            os.mkdir('data/mode sl/results noj upgrade/' + symbol_elle)
        ...
        plt.tight_layout()
        plt.savefig('data/mode sl/results noj upgrade/' + symbol_elle + '/train_loss_{}.png'.format(run))
        ...
        plt.tick_params(axis='both', which='major')
        plt.tight_layout()
        plt.savefig('data/mode sl/results noj upgrade/' + symbol_elle + '/valid_loss_{}.png'.format(run))
        ...
        params_predicted_train_df.to_csv('data/mode sl/results noj upgrade/' + symbol_elle + '/params_predicted_train_{}.csv'.format(run), index=False)
        q_params_predicted_train_df.to_csv('data/mode sl/results noj upgrade/' + symbol_elle + '/q_params_predicted_train_{}.csv'.format(run), index=False)

        params_predicted_valid_df.to_csv('data/mode sl/results noj upgrade/' + symbol_elle + '/params_predicted_valid_{}.csv'.format(run), index=False)
        q_params_predicted_valid_df.to_csv('data/mode sl/results noj upgrade/' + symbol_elle + '/q_params_predicted_valid_{}.csv'.format(run), index=False)

        params_predicted_test_df.to_csv('data/mode sl/results noj upgrade/' + symbol_elle + '/params_predicted_test_{}.csv'.format(run), index=False)
        q_params_predicted_test_df.to_csv('data/mode sl/results noj upgrade/' + symbol_elle + '/q_params_predicted_test_{}.csv'.format(run), index=False)

        # Compute the test results noj upgrade
        ...
        with open('data/mode sl/results noj upgrade/' + symbol_elle + '/results_{}.txt'.format(run), 'w') as file:
